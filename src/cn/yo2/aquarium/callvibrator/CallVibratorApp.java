...
public class CallVibratorApp extends Application {
    ...
    public void onCreate() {
        ...
        if (BuildConfig.DEBUG) {
            ...
            MyLog.initLog(TAG, true, true); // only log level above info in
                                            // release version
        }
        MyLog.d("onCreate()");
    }
    ...
    public int checkOutgoingCallFeasible() {
        ...
        final String grantPermissionCommand = String.format("pm grant %s %s", getPackageName(),
                READ_LOGS_PERMISSION);
